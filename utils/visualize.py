...
def aug_depth_params(K, n_steps= 75):
    ...
    for angle in roll_aug:
        ...
        aug_params.append([linalg.inv(K), ang_x, ang_y, ang_z])
    ...
    for f_idx in range(100 + 1):
        ...
        K_aug[:, :, 0, 0] *= f_scale
        K_aug[:, :, 1, 1] *= f_scale
        aug_params.append([linalg.inv(K_aug), ang_x, ang_y, ang_z])
